...
@Component
public class ImmunityActionHandler implements InGameActionHandler<ImmunityActionDTO> {
    @Autowired
    ...
    @Override
    public void handle(ImmunityActionDTO request, WebSocketSession session, String tokenGameId) {
        String userId = (String) session.getAttributes().get("userId");

        GameAction action = new ImmunityPlayerAction(request.actionId());
